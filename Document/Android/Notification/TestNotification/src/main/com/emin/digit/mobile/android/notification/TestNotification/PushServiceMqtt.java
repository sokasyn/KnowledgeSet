...
public class PushServiceMqtt extends Service{
    ...
    private static final String		MQTT_HOST = "127.0.0.1"; //"192.168.0.51";
    ...
    public static String			MQTT_CLIENT_ID = "emin";
    ...
    private class MQTTConnection implements MqttSimpleCallback {
        ...
        public MQTTConnection(String brokerHostName, String initTopic) throws MqttException {
            ...
            Log.i(TAG,"MQTTConnection constructor mqttConnSpec:" + mqttConnSpec);

            // Create the client and connect
            mqttClient = MqttClient.createMqttClient(mqttConnSpec, MQTT_PERSISTENCE);
            String clientID = MQTT_CLIENT_ID + "/" + mPrefs.getString(PREF_DEVICE_ID, "");
            Log.i(TAG,"MQTTConnection constructor clientID:" + clientID);
            mqttClient.connect(clientID, MQTT_CLEAN_START, MQTT_KEEP_ALIVE);

            Log.i(TAG,"MQTTConnection constructor connect 11111");

            // register this client app has being able to receive messages
            mqttClient.registerSimpleHandler(this);

            Log.i(TAG,"MQTTConnection constructor connect 22222");

            // Subscribe to an initial topic, which is combination of client ID and device ID.
            initTopic = MQTT_CLIENT_ID + "/" + initTopic;
            subscribeToTopic(initTopic);

            Log.i(TAG,"MQTTConnection constructor connect 33333");
        ...
        private void subscribeToTopic(String topicName) throws MqttException {
            Log.i(TAG,"subscribeToTopic :" + topicName);
